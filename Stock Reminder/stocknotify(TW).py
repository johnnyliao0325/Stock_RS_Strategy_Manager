...
# 準備買入股票
stockID_list = '2204 1514 6122 1524 6353 6808'.split(' ')
note_text2 = ['B，小時線收破134買0.1，日線收破134買0.2(1522已經買0.25)',
              'C，小時線收破116 買0.2，日線收破116買0.1，小時線收破118.5買0.1，日線收破118.5買0.1，日線收破120買0.1。',
              'B，小時線收破71.6買0.2，日線收破71.6買0.3，拉回可以買0.1再突破買0.1，剩下等突破77.3買。',
              'B，目前倉位0.2，日線收破37.7買0.2小時驗收破38.3買0.1，日線收破38.3買0.1，，剩下等突破拉回買。',
...
# 買入點 
buy_price_list = [134, 116, 71.6, 37.7, 193, 154]
# 準備買入股票的停損點
newstock_stop_loss = [124.5, 109.5, 67.8, 36.1, 180, 143.5]
# 準備買入股票 note
